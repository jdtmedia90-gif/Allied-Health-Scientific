...
const WEB_APP_URL = "https://script.google.com/macros/s/AKfycbx.../exec"; // replace with deployed Apps Script URL
...
document.getElementById("checkout-btn").addEventListener("click", async ()=>{
  ...
  try {
    ...
    alert("Order sent! We'll contact you. Status: "+(data.status||"ok"));
    cart = [];
    saveCart();
